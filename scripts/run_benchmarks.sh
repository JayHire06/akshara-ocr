...
# Executing legacy iterations v1 through v4 sequentially for project reporting comparison limits.
...
echo "      Akshara-OCR Reporting Benchmark Initialized" | tee -a "$BENCHMARK_LOG"
